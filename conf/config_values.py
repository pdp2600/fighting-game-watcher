...
sin_templ_imgs =  {'Name': 'Sin', 
					   'Min_Portrait_Match': 0.25, 'Min_Win_Pose_Match': 0.3, 
                       'img_paths': {
									 '1P_Portrait': template_img_folder +  
                                       'Characters\\Sin\\Sin_Portrait_P1.png', 
                                     '2P_Portrait': template_img_folder + 
                                       'Characters\\Sin\\Sin_Portrait_P2.png'
                                     #'Win_Pose_Left': template_img_folder + 
                                     #  'Characters\\Sin\\Sin_Win_Pose_Left.png', 
                                     #'Win_Pose_Right': template_img_folder + 
                                     #  'Characters\\Sin\\Sin_Win_Pose_Right.png'
                                  }, 
                      'img_objs': {}
                     }
